...
1. **Landing Page**
   ![Landing](./content/i2.png)

2. **User Dashboard**
   ![Dashboard](./content/i3.png)
   
3. **User Dashboard Porject view and dynamic updates**
   ![Dashboard](./content/i6.png)

4. **Building Details**
   ![Building Form](./content/i4.png)
   
5. **Building Calculator Form**
   ![Building Form](./content/i5.png)

6. **Building Details**
   ![Building Form](./content/i8.png)
   
7. **Building Calculator Form**
   ![Building Form](./content/i9.png)
